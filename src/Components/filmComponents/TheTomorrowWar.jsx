const theTomorrowWarPicture = "/assets/assetgambar/assetgambarberanda/filmnya/thetomorrowwar.png";
import { useState } from "react";



import "../filmComponents/filmobjectcss.css"
function TheTomorrowWar(){
        ...
        const title = "The Tomorrow War"

    return(
        <>
        <div className="filmobject" onClick={() => setIsOpen(true)} style={{ backgroundImage:`url(${theTomorrowWarPicture})`}}></div>
        {isOpen && (
            <div className="overlay">
                <div className="filmpopup">
                    <button className="closebigpicture" onClick={()=>setIsOpen(false)}>X</button>
                    <div className="bigpicture">
                        <img src={theTomorrowWarPicture}/>
