const allOfUsAreDeadPicture = "../assets/assetgambar/assetgambarberanda/filmnya/allofusaredead.png";
import { useState } from "react";

import "../filmComponents/filmobjectcss.css"
function AllOfUsAreDead(){
        ...
        const title = "All of Us Are Dead"
    return(
        <>
        <div className="filmobject" onClick={() => setIsOpen(true)} style={{ backgroundImage:`url(${allOfUsAreDeadPicture})`}}></div>
        {isOpen && (
            <div className="overlay">
                <div className="filmpopup">
                    <button className="closebigpicture" onClick={()=>setIsOpen(false)}>X</button>
                    <div className="bigpicture">
                        <img src={allOfUsAreDeadPicture}/>
