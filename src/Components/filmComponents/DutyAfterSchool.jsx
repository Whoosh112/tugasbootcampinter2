const dutyAfterSchoolPicture = "/assets/assetgambar/assetgambarberanda/filmnya/dutyafterschool.png";
import { useState } from "react";

import "../filmComponents/filmobjectcss.css"
function DutyAfterSchool(){
        ...
        const title = "Duty After School"
    return(
        <>
        <div className="filmobject" onClick={() => setIsOpen(true)} style={{ backgroundImage:`url(${dutyAfterSchoolPicture})`}}></div>
        {isOpen && (
            <div className="overlay">
                <div className="filmpopup">
                    <button className="closebigpicture" onClick={()=>setIsOpen(false)}>X</button>
                    <div className="bigpicture">
                        <img src={dutyAfterSchoolPicture}/>
...
export default DutyAfterSchool