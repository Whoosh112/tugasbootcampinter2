const aManCalledOttoPicture = "/assets/assetgambar/assetgambarberanda/filmnya/amancalledotto.png";
import { useState } from "react";

import "../filmComponents/filmobjectcss.css"
function AManCalledOtto(){
        ...
        const title = "A Man Called Otto"
    return(
        <>
        <div className="filmobject" onClick={() => setIsOpen(true)} style={{ backgroundImage:`url(${aManCalledOttoPicture})`}}></div>
        {isOpen && (
            <div className="overlay">
                <div className="filmpopup">
                    <button className="closebigpicture" onClick={()=>setIsOpen(false)}>X</button>
                    <div className="bigpicture">
                        <img src={aManCalledOttoPicture}/>
